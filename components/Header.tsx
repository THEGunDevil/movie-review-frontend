        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
          ...
          <div className="flex items-center gap-5">
            ...
            <Link href={`/profile/${userID}`}>
              <Button className="flex justify-center items-center border-slate-100 border-2 rounded-full w-8 h-8 hover:bg-red-700 cursor-pointer">
            ...
            return (
              <Link
                ...
                className={`flex flex-col items-center justify-center w-full h-full gap-1 transition-colors ${
                  isActive
                    ? "bg-linear-to-r from-red-400 to-pink-500 text-transparent bg-clip-text"
              ...
              >
                ...
                {isActive && (
                  <span className="absolute top-0 w-8 h-0.5 bg-linear-to-r from-red-400 to-pink-500 shadow-[0_0_8px_0_rgba(45,212,255,0.8)]" />
                )}
              </Link>
            );
          })}
